...
import { Status } from "./projects/Modals/ModalEditTask";
...
const taskData = [
  { Status: "High", tasks: 20 },
  { Status: "Medium", tasks: 16 },
  { Status: "Low", tasks: 12 },
  { Status: "Backlog", tasks: 22 },
...
const Dashboard = () => {
  return (
    <div style={{ padding: "32px", marginLeft: "", animation: "fadeIn 0.5s" }}>
      <h1
